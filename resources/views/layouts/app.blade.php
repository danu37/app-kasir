...
<body>
<aside class="sidebar">
    <a class="brand" href="{{ route(auth()->user()->isAdmin() ? 'dashboard' : 'cashier.index') }}"><span class="brand-icon"><i class="ti ti-building-store"></i></span><span><b>Kasir Mini</b><small>Point of Sale</small></span></a>
